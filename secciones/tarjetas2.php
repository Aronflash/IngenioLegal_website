        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <p>En el marco de nuestra materia de Marco Legal en la carrera de Ingeniería en Sistemas, hemos abordado la creación y análisis de documentos legales fundamentales para la constitución y operación de entidades comerciales. En esta ocasión, presentaremos tres documentos clave: dos correspondientes a una firma personal y una compañía anónima ficticias, que hemos elaborado como parte de nuestro aprendizaje práctico.</p>
                    <p>A través de estos documentos, hemos explorado cómo se formalizan y regulan diferentes tipos de entidades comerciales en Venezuela, comprendiendo las implicaciones legales y operativas de cada tipo de estructura. Pero, ¿Cómo saber si debo elegir una u otra?</p>
                    <p>La Firma Personal es una estructura empresarial simple en la que el propietario tiene responsabilidad ilimitada, lo que significa que responde personalmente por las deudas del negocio. Esta forma es adecuada para pequeños negocios con un alcance local que buscan flexibilidad y control total. En contraste, una Compañía Anónima proporciona responsabilidad limitada a sus accionistas, protegiendo su patrimonio personal y facilitando la captación de capital y la expansión. Es ideal para empresas con planes de crecimiento significativo y múltiples socios, ya que permite una gestión profesional y una mayor protección legal. La elección entre una u otra depende del tamaño del negocio, el riesgo involucrado y los objetivos de expansión.</p>
                    <p>Aquí puedes acceder a los diferentes documentos de Actas Constitutivas que hemos creado:</p>
                </div>
            </div>
